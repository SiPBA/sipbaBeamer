...
\definecolor{darkred}{RGB}{207,90,0}
\definecolor{greyUGR}{RGB}{125,126,126}
\definecolor{darkGrey}{RGB}{50,50,50}
\definecolor{darkgreen}{RGB}{30,50,10}
\definecolor{clearblue}{RGB}{97,97,255}


\setbeamercolor{Aalborg}{fg=darkgreen!20,bg=greyUGR}
%\setbeamercolor{sidebar}{bg=greyUGR!20}
% Change the color of the structural elements:
\setbeamercolor{structure}{fg=darkgreen}
\setbeamercolor{titlepagecolorbox}{fg=greyUGR, bg=}
\setbeamercolor{frametitle}{fg=darkred}
\setbeamercolor{framesubtitle}{fg=greyUGR}
\setbeamercolor{subtitle}{fg=darkred}
\setbeamercolor{section in toc}{fg=darkred}
\setbeamerfont{section in toc}{series=\bfseries}
\setbeamercolor{section in sidebar}{fg=darkred}
...
\subtitle{Titulo conferencia
}  % could also be a conference name

\author[corresponding]{autor1\inst{1},  \underline{autor2}\inst{2}...}

\institute[Dept. of Signal Theory, Networking and Communications\\Universidad de Granada] % (optional)
{
	\inst{1} Dept. of Signal Theory, Networking and Communications. Universidad de Granada, Spain\\
	\inst{2} Department of Communications Engineering. Universidad de Malaga, Spain.
}

% specify the logo in the top right/left of the slide
\pgfdeclareimage[height=1.3cm]{mainlogo}{AAUgraphics/escudosipba} % placed in the upper left/right corner
\logo{\pgfuseimage{mainlogo}}

% specify a logo on the titlepage (you can specify additional logos an include them in 
% institute command below
\pgfdeclareimage[height=1cm]{titlepagelogo}{AAUgraphics/logoalter} % placed on the title page
\pgfdeclareimage[height=1cm]{titlepagelogo2}{AAUgraphics/Horizontal} % placed on the title page
...
\setbeamerfont{subtitle}{series=\itshape,size=\normalsize}
...
\begin{frame}{User Interface}{Loading the Theme and Theme Options}
  ...
  \begin{block}{The Color Element {\tt Aalborg}}
    ...
    \begin{itemize}
      \item fg: {\usebeamercolor[fg]{Aalborg}light blue (\{RGB\}\{194,193,204\})}
      \item bg: {\usebeamercolor[bg]{Aalborg}dark blue (\{RGB\}\{33,26,82\})}
    \end{itemize}
